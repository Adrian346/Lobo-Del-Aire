...
<div>
   ...
   <h1>Agregar Detalle de Compra</h1>
    <form class="formulario" action="pages/agregarDetalleDirectoCompra.php" method="POST">
        <?php
        ...
        <input class="text" name="precio_final" type="number" placeholder="Precio Final" step="0.01" required>
        <input class="text" name="cantidad_compra" type="number" placeholder="Cantidad de Compra" required>
